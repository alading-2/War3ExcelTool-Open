...
class TSGenerator:
    ...
    def generate_ts_file(self, excel_name: str,
        ...
        try:
            ...
            for row_idx in range(2, excel_table.num_rows):
                ...
                if row_entries:
                    ...
                    data_key = excel_table.get_value(row_idx,
                                                     0)  # 获取当前行第一列作为数据项的key值
                    data_entries.append(
                        f'    "{data_key}":{{\n{",\n".join(row_entries)}\n    }},'
                    )
    ...
    def extract_ts_code(self, excel_table: ExcelTable,
