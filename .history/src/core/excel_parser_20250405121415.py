...
from src.core.pretreatment import apply_column_preprocessors, extract_preprocessor_directives, apply_preprocessors, PREPROCESSOR_ACTIONS
    ...
    def parse_excel(
        ...
        try:
            ...
            for sheet_name in sheet_names:
                ...
                # 从前几行提取预处理指令
                column_preprocessors, df_raw = extract_preprocessor_directives(
                    df_raw)
                df = apply_column_preprocessors(df_raw, column_preprocessors)
