...
class ExcelToIniGenerator:
    ...
    def __init__(self, config_manager: ConfigManager):
        ...
        # 加载模板文件
        self.ini_template_data = self._load_ini_template()
    ...
    def _load_ini_template(self) -> Dict[str, Dict[str, Any]]:
        """
        加载INI模板文件
    ...
    def _load_editor_info_map(self) -> Dict[str, Dict[str, Any]]:
        """
        加载编辑器信息映射
        ...
        try:
            if not os.path.exists(self.editor_info_map_path):
                ...
                return {}
            return War3IniParser.parse_ini(self.editor_info_map_path)
        except Exception as e:
            self.logger.error(
                f"加载编辑器信息映射失败: {str(e)}\n{traceback.format_exc()}")
            return {}
