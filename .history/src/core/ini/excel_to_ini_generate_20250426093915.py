...
from src.core.ini.war3_ini_parser import War3IniParser
...
class ExcelToIniGenerator:
    ...
    # 物编类型映射，与ini_parser.py中的OBJECT_TYPE_MAPPING对应
    OBJECT_TYPE_MAPPING = {
        "单位": "unit",
        "unit": "unit",
        "技能": "ability",
    ...
    def __init__(self, config_manager: ConfigManager, logger: Logger):
        ...
        # 模板文件路径
        self.template_path = self.root_path / "resource" / "resource" / "excel_to_ini" / "excel_to_ini_template.ini"

        # 编辑器信息映射文件路径
        self.editor_info_map_path = self.root_path / "resource" / "resource" / "editor_info_map.ini"

        # 基础命令ID文件路径
        self.base_orders_path = self.root_path / "resource" / "resource" / "excel_to_ini" / "基础命令id.txt"
    ...
    def _load_template(self) -> Dict[str, Dict[str, Any]]:
        ...
        try:
            ...
            return War3IniParser.parse_ini(self.template_path)
    ...
    def get_object_type(self, sheet_name: str,
        ...
        """
        # 首先根据sheet名判断
        if sheet_name.lower() in self.OBJECT_TYPE_MAPPING:
            return self.OBJECT_TYPE_MAPPING[sheet_name.lower()]
