...
def process_files(config: dict):
    ...
    for excel_file in excel_files:
        try:
            ...
            ini_data = ExcelParser.parse_excel(excel_file)
            ...
            if convert_to_ts:
                ...
                # 生成ts文件
                TSGenerator.generate_ts_file(excel_name,ini_data, ts_output_dir)
        ...
        try:
            ...
            if w3x_files:
                ...
                for w3x_file in w3x_files:
                    ...
                    temp_output_dir = os.path.join(base_output_dir, "output", "w3x", f"{w3x_basename}")
    ...
    if convert_ini_to_excel:
        ...
        ini_files = find_files(input_path, recursive, ("*.ini",)) # 使用 input_path 查找 ini 文件
