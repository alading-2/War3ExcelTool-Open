...
def parse_args():
    ...
    parser.add_argument(
        "-r",
        "--recursive",
        action="store_true",  # 填了参数-r，没有填值，存储true
        default=True,  # 没有填参数-r，默认true
    ...
    parser.add_argument(
        "--tots",
        action="store_true",  # 填了参数-r，没有填值，存储true
        default=True,  # 没有填参数--tots，默认True
        help="是否开启Excel转ts，默认True",
    )
    # Excel转lua文件
    parser.add_argument(
        "--tolua",
        action="store_false",  # 填了参数-r，没有填值，存储false
