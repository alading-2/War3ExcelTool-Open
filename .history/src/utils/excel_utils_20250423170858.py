...
def format_excel_workbook(file_path):
    ...
    sort_by_alpha = config_manager.get("sort_by_alpha")  # 是否按字母顺序排序
    font_size = config_manager.get("font_size")  # 字体大小
    try:
        # 确保文件未被打开
        ...
        # 创建字体样式 - 设置字体大小为14
        font = Font(size=font_size)  # 字号14，便于阅读
