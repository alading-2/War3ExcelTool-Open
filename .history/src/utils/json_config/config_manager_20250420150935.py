...
class JsonConfigManager:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        # 默认配置文件路径
        self.default_config_path = os.path.join("resource", "resource", "config.cfg")
        # 设置配置文件路径
        self.config_path = config_path or os.path.join("config.cfg")
        
        # 加载配置
        JsonConfigManager.config = self._load_config()
        ...
        try:
            ...
            if not os.path.exists(self.config_path):
                ...
                if os.path.exists(self.default_config_path):
                    self.logger.info(f"从默认位置复制配置文件: {self.default_config_path}")
    ...
    def save_config(self) -> bool:
        ...
        Returns:
            是否成功保存
        """
        success = self._save_config_internal(JsonConfigManager.config)
        if success:
    ...
    def get(self, key: str, default: Any = None) -> Any:
        ...
        Returns:
            配置值
        """
        return JsonConfigManager.config.get(key, default)
    ...
    def set(self, key: str, value: Any) -> None:
        ...
        Args:
            ...
            value: 配置值
        """
        JsonConfigManager.config[key] = value
    ...
    def update(self, config_dict: Dict[str, Any]) -> None:
        ...
        """
        JsonConfigManager.config.update(config_dict)
    ...
    def get_all(self) -> Dict[str, Any]:
        ...
        Returns:
            完整的配置字典
        """
        return JsonConfigManager.config.copy()
    
    def reset_to_default(self) -> None:
        """
        重置配置为默认值
        """
        JsonConfigManager.config = self.DEFAULT_CONFIG.copy() 