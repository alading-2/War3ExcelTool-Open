...
from src.utils.main_args import MainArgs  # 从新模块导入MainArgs

# 设置MainArgs的静态属性
MainArgs.abs_path = os.path.abspath(__file__)
MainArgs.base_dir = os.path.dirname(MainArgs.abs_path)
MainArgs.config_path = os.path.join(MainArgs.base_dir, "config.cfg")
...
def main():
    ...
    ConfigManager.config_path = MainArgs.config_path  # 设置配置文件路径
