...
# 编辑器中英文映射生成测试
war3_ini_parser = War3IniParser(iseditor_info_test=True)
dict1, comment1 = war3_ini_parser.parse_ini(path1)
dict2, comment2 = war3_ini_parser.parse_ini(path2)
# 中英文映射字典
map_dict = {}
# 中文注释映射
