...
from src.core.ts.ts_generator import TSGenerator  # 根据实际路径调整导入

from src.core.excel.excel_parser import ExcelParser  # 根据实际路径调整导入
...
sheet_name, metadata = results[0]
output_file = tsgenerator.generate_ts_file("test", metadata, r"else\Test\ts\test")
