...
class MainWindow(QMainWindow):
    ...
    def __init__(self,config_path):
        ...
        # 加载配置管理器，用于读写应用程序设置
        self.config_manager = JsonConfigManager(config_path)
    ...
    def start_conversion(self):
        ...
        config = {
            ...
            "baize_frame": self.config_manager.get("baize_frame", True), # 白泽框架
        }
    ...
    def load_config(self):
        ...
        # 加载是否递归处理输入目录选项
        self.recursive_check.setChecked(self.config_manager.get("recursive", True))
        # 加载 Excel -> * 的转换选项
        self.convert_to_ts_check.setChecked(self.config_manager.get("convert_to_ts", False))
        ...
        # 加载白泽框架选项
        self.baize_frame_check.setChecked(self.config_manager.get("baize_frame", True))
    ...
    def save_config(self):
        ...
        # 保存白泽框架选项
        self.config_manager.set("baize_frame", self.baize_frame_check.isChecked())
