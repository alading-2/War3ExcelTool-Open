...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.ini_input_group.setVisible(False) # 初始隐藏
        ...
        # 连接 Ini->Excel 复选框以显示/隐藏 INI 输入组
    ...
    def start_conversion(self):
        ...
        config = {
            ...
            "ini_input_path": self.ini_input_edit.text().strip(), # INI 输入路径 (文件或目录)
            # --- 转换选项 --- 
        ...
        if ini_to_excel:
            if not config["ini_input_path"]:
                 ...
                 return
            if not os.path.exists(config["ini_input_path"]):
    ...
    def load_config(self):
        ...
        # 根据加载的 Ini->Excel 选项，切换INI输入组的可见性
    ...
    def save_config(self):
        ...
        # 如果有 Ini 输入:
        #     self.config_manager.add_recent_file(ini_input) # 添加到最近文件列表
