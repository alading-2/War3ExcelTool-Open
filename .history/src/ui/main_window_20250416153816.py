...
class ConversionWorker(QThread):
    ...
    def __init__(self, input_dir: str, output_dir: str, recursive: bool):
        ...
        # 输出目录默认为用户设置的输出目录+output+ts
        self.output_dir = os.path.join(output_dir, "output", "ts")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # 设置窗口属性
        self.setWindowTitle("War3ExcelTool(Excel转ts、lua、ini，ini转excel)")
    ...
    def show_about_dialog(self):
        ...
        QMessageBox.about(
            self,
            "关于War3ExcelTool(Excel转ts、lua、ini，ini转excel)",
            "War3ExcelTool(Excel转ts、lua、ini，ini转excel) v1.0.0\n\n"
    ...
    def save_config(self):
        ...
        self.config_manager.set("recursive", 
