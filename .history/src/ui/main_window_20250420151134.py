...
class MainWindow(QMainWindow):
    ...
    def load_config(self):
        ...
        # 转换选项
        self.convert_to_ts_check.setChecked(current_config.get("convert_to_ts", False))
        self.convert_to_lua_check.setChecked(current_config.get("convert_to_lua", False))
        self.convert_to_ini_check.setChecked(current_config.get("convert_to_ini", False))
        self.convert_ini_to_excel_check.setChecked(current_config.get("convert_ini_to_excel", False))
        
        # 其他选项
        self.recursive_check.setChecked(current_config.get("recursive", True))
        self.baize_frame_check.setChecked(current_config.get("baize_frame", True))
    ...
    def save_config(self):
        ...
        config["convert_ini_to_excel"] = self.convert_ini_to_excel_check.isChecked()
