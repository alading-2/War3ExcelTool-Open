...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="War3Excel工具",formatter_class=argparse.ArgumentDefaultsHelpFormatter,  # 显示默认值)

    # 添加输入目录参数，用-i或--input指定
    parser.add_argument("-i", "--input", help="设置输入目录")
    # 添加输出目录参数，用-o或--output指定
    parser.add_argument("-o", "--output", help="设置输出目录")
