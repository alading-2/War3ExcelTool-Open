export const xlsx_inte_keys_DotA全逆天模拟触发未加密版_科技 = [
...
export interface xlsx_inte_DotA全逆天模拟触发未加密版_科技 {
    [key: string]: {
        "id"?: string;    // id
...
export const xlsx_data_DotA全逆天模拟触发未加密版_科技: xlsx_inte_DotA 全逆天模拟触发未加密版_科技 = {
    "Reib":{
        "id": "Reib",
        "_parent": "Reib",
        "Name": {'灵能之刃 加射程'},
