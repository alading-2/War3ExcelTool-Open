export const xlsx_inte_keys_table_9b80ad3e-d1ca-4b2e-afa2-cbb693670311_unit = [
...
export interface xlsx_inte_table_9b80ad3e-d1ca-4b2e-afa2-cbb693670311_unit {
    [key: string]: {
        "名字#color"?: string;    // 名字
        "类别"?: string;    // 类别
        "等级"?: number;    // 等级
...
export const xlsx_data_table_9b80ad3e-d1ca-4b2e-afa2-cbb693670311_unit: xlsx_inte_table_9b80ad3e-d1ca-4b2e-afa2-cbb693670311_unit = {
    "助手":{
        "名字#color": "助手",
        "类别": "助手",
        "等级": 1,
...
export class xlsx_table_9b80ad3e-d1ca-4b2e-afa2-cbb693670311_unit {
    static Start() {
        const data=xlsx_data_table_9b80ad3e-d1ca-4b2e-afa2-cbb693670311_unit;
    }
}
