export const xlsx_inte_keys_演员技能.ts = [
"id","class","index","name","describe","stateFormula","attribute","targetType"," passive","icon","model","range","area","manaCost","hotKey","maxCd","x","y","#<%1%>#"
];

export interface xlsx_inte_演员技能.ts {
    [key: string]: {
        "id"?: string;    // 自定义id
<%
...
export const xlsx_data_演员技能.ts: xlsx_inte_演员技能.ts = {
    "群锤":{
        "id": "群锤",
        "class": "技能",
        "index": 0,
...
export class xlsx_演员技能.ts {
    static Start() {
        const data=xlsx_data_演员技能.ts;
    }
}
