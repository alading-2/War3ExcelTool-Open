...
const xlsx_inte_keys_演员单位 = ["名字", "类别", "等级", "基础生命值", "攻击力", "防御", "cool1", "spd", "属性", "acquire", "rangeN1", "movetp", "moveHeight", "file", "modelScale", "RGBA", "弹道模型", "弹道大小", "弹道速度", "collision", "血条高度", "unitSound", "scale",]
...
const xlsx_data_演员单位: xlsx_inte_演员单位 = {
    "助手": {
        名字: "助手",
        类别: "助手",
        等级: 1,
...
export class xlsx_演员单位 {
    static Start() {
        Object.entries(data).forEach(([id, data1]) => {
            ActorTypeUtil.registerActorType(data1 as any);
        });
    }
}